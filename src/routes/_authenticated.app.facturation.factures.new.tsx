...
export const Route = createFileRoute("/_authenticated/app/facturation/factures/new")({
...
function NewInvoicePage() {
  ...
  const save = useMutation({
    mutationFn: async (issue: boolean) => {
      ...
      if (issue) {
        await transitionFn({ data: { documentId: docId, to: "issued" } });
      }
    ...
    <div className="space-y-4 max-w-5xl">
      ...
      <header>
        ...
        <p className="text-sm text-muted-foreground">
          4 étapes guidées pour une facture conforme (Art. L441-9 C.com).
        </p>
      </header>
